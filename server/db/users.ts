...
export default class UsersDB {
  ...
  public static async addUser(data: InsertUserData) {
  ...
  public static async updateUser({ id: userId, updateValues }: UpdateUserData) {
    const client = await db.getClient();
  ...
  public static async updatePostazioniToUser(
  ...
  public static async deletePostazioneToUser(deleteData: PostazioneUser) {
